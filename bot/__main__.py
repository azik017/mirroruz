...
from bot import bot, app, IMAGE_URL, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, IS_VPS, PORT, alive, web, OWNER_ID, AUTHORIZED_CHATS, telegraph_token
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        bot.edit_message_text("Bot qayta yuklandi!", chat_id, msg_id)
